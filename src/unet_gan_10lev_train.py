...
datapath= '/home/tyuan/fastdisk/' #where training and test data is located
temp = "T"
rh = "RH"
u = "U"
v = "V"
...
class Dataset(data.Dataset):
    ...
    def __init__(self, root, years,resol_str, x_field, y_field, start=0,stop=-1, Cout = 3, Cin=41):
        ...
        for year in years:
            ...
            x_path = "{}/{}/{}/{}".format(root,x_field,year,resol_str)
            y_path = "{}/{}/{}/{}".format(root,y_field,year,resol_str)
...
trainset = Dataset(datapath,[2016],'256x256','meto2','imgs')
...
class gan_trainer:
    ...
    def __init__(self, nepochs=50):
        ...
        self.runpath      = '/home/tyuan/run_output/'+self.runname+'/output_'+self.timestamp
        self.results      = []
